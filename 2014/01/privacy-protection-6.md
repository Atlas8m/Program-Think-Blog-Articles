...
　　对于【不】使用虚拟机的普通网友，其屏幕分辨率也就是常见的那几种（大概在20种以内）。但如果你在 Guest OS 里面上网，并且你【没有】使用全屏模式，那么 Guest OS 的分辨率可能会是一个很奇怪的分辨率（因为独特性很高，也就带有更多的“指纹信息量”）。<br/>
　　所以，俺建议那些用虚拟系统上网的同学，采用如下几个措施：<br/>
<br/>
