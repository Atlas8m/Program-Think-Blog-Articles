...
<br/>
<hr/>　　在<a href="../../2014/11/https-ssl-tls-1.md">本系列的前一篇</a>，已经介绍了相关的背景知识以及设计 SSL 需要考虑的需求。当时俺提到：设计 HTTPS 的最大难点（没有之一）是——如何在互联网上进行安全的“密钥交换”。今天就来讲讲密钥交换的难点和解决方法（暂不谈技术实现）。<br/>
<a name="more"></a><br/>
<br/>
...
<br/>
<br/>
<h2>★如何解决 SSL 的【身份认证】问题——CA 的引入</h2><br/>
...
　　所谓的 CA，就是“数字证书认证机构”的缩写，洋文全称叫做“Certificate Authority”。关于 CA 以及 CA 颁发的“CA 证书”，俺已经写过一篇教程：《<a href="../../2010/02/introduce-digital-certificate-and-ca.md">数字证书及 CA 的扫盲介绍</a>》，介绍其基本概念和功能。所以，此处就不再重复唠叨了。<br/>
...
<blockquote><b>第1步（这是“一次性”的准备工作）</b><br/>
